...
if (!uye) return message.reply({ content:` • Örnek; !perm @stfu/ID`});
...
collector.on("collect", async (interaction) => {
     ...
     if (interaction.values[0] === "vip") {
        ...
        if(!uye.roles.cache.has(ayar.vipRole)) {
          ...
          msg.edit({ content:`:white_check_mark: Başarıyla ${uye}, isimli kişiye **Vip** rolü verildi.`, components: [] });
        } else {
          ...
          msg.edit({ content:`:white_check_mark: Başarıyla ${uye}, isimli kişinin **Vip** rolü geri alındı.`, components: [] });
        };
     }
     ...
     if (interaction.values[0] === "müzisyen") {
        ...
        if(!uye.roles.cache.has(ayar.müzisyenRole)) {
          ...
          msg.edit({ content:`:white_check_mark: Başarıyla ${uye}, isimli kişiye **Müzisyen** rolü verildi.`, components: [] });
        } else {
          ...
          msg.edit({ content:`:white_check_mark: Başarıyla ${uye}, isimli kişinin **Müzisyen** rolü geri alındı.`, components: [] });
        };
     }
    ...
    if (interaction.values[0] === "tasarımcı") {
        ...
        if(!uye.roles.cache.has(ayar.tasarımcıRole)) {
          ...
          msg.edit({ content:`:white_check_mark: Başarıyla ${uye}, isimli kişiye **Tasarımcı** rolü verildi.`, components: [] });
        } else {
          ...
          msg.edit({ content:`:white_check_mark: Başarıyla ${uye}, isimli kişinin **Tasarımcı** rolü geri alındı.`, components: [] });
        };
     }
    ...
    if (interaction.values[0] === "streamer") {
        ...
        if(!uye.roles.cache.has(ayar.streamerRole)) {
          ...
          msg.edit({ content:`:white_check_mark: Başarıyla ${uye}, isimli kişiye **Streamer** rolü verildi.`, components: [] });
        } else {
          ...
          msg.edit({ content:`:white_check_mark: Başarıyla ${uye}, isimli kişinin **Streamer** rolü geri alındı.`, components: [] });
        };
     }
     ...
     if (interaction.values[0] === "terapi") {
      ...
      if(!uye.roles.cache.has(ayar.terapistRole)) {
        ...
        msg.edit({ content:`:white_check_mark: Başarıyla ${uye}, isimli kişiye **Terapist** rolü verildi.`, components: [] });
      } else {
        ...
        msg.edit({ content:`:white_check_mark: Başarıyla ${uye}, isimli kişinin **Terapist** rolü geri alındı.`, components: [] });
      };
   }
    ...
    if (interaction.values[0] === "sorun") {
        ...
        if(!uye.roles.cache.has(ayar.sorunçözücüRole)) {
          ...
          msg.edit({ content:`:white_check_mark: Başarıyla ${uye}, isimli kişiye **Sorun Çözücü** rolü verildi.`, components: [] });
        } else {
          ...
          msg.edit({ content:`:white_check_mark: Başarıyla ${uye}, isimli kişinin **Sorun Çözücü** rolü geri alındı.`, components: [] });
        };
     }
    })

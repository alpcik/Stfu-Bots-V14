...
channel.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(stfucum.GuildID).name, iconURL: client.guilds.cache.get(stfucum.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
:white_check_mark: ${newState.member} isimli kullanıcı bir sesli kanalına girdi.
...
channel.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(stfucum.GuildID).name, iconURL: client.guilds.cache.get(stfucum.GuildID).iconURL({dynamic:true})}).setThumbnail(oldState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
:x: ${oldState.member} isimli kullanıcı bir sesli kanalından ayrıldı.
...
channel.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(stfucum.GuildID).name, iconURL: client.guilds.cache.get(stfucum.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
:white_check_mark: ${newState.member} isimli kullanıcı bir sesli kanal değişimi yaptı.
...
channel2.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(stfucum.GuildID).name, iconURL: client.guilds.cache.get(stfucum.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
:x: ${newState.member} isimli kullanıcı bir sesli kanalda kendi susturmasını kaldırdı.
...
channel2.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(stfucum.GuildID).name, iconURL: client.guilds.cache.get(stfucum.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
:white_check_mark: ${newState.member} isimli kullanıcı bir sesli kanalda kendini susturdu.
...
channel2.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(stfucum.GuildID).name, iconURL: client.guilds.cache.get(stfucum.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
:x: ${newState.member} isimli kullanıcı bir sesli kanalda kendi sağırlaştırmasını kaldırdı.
...
channel2.wsend({ embeds: [new EmbedBuilder().setAuthor({ name: client.guilds.cache.get(stfucum.GuildID).name, iconURL: client.guilds.cache.get(stfucum.GuildID).iconURL({dynamic:true})}).setThumbnail(newState.member.displayAvatarURL({ dynamic: true, size: 2048 })) 
.setDescription(`
:white_check_mark: ${newState.member} isimli kullanıcı bir sesli kanalda kendini sağırlaştırdı.

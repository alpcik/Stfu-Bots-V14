...
if (KickLimit[entry.executor.id] && KickLimit[entry.executor.id].Now + 1 > stfucum.Guard.Limit.Kick) {
    if (victimMember) {
...
.setDescription(`
${entry.executor} yetkilisi **${stfucum.Guard.Limit.Kick}** Kick limitini geçtiği için sunucudan banlandı.
─────────────────────
...
.setThumbnail(entry.executor.avatarURL({ dynamic: true }))
.setDescription(`
${entry.executor} yetkilisi kalan Kick Limit: **${1}/${stfucum.Guard.Limit.Kick}**.
─────────────────────
Yetkili: (${entry.executor} - \`${entry.executor.id}\`)
Kullanıcı: \`${member.user.tag}\` - \`${member.user.id}\`
─────────────────────
...
.setThumbnail(entry.executor.avatarURL({ dynamic: true }))
.setDescription(`
${entry.executor} yetkilisi kalan Kick Limit: **${KickLimit[entry.executor.id].Now}/${stfucum.Guard.Limit.Kick}**.
─────────────────────
Yetkili: (${entry.executor} - \`${entry.executor.id}\`)
Kullanıcı: \`${member.user.tag}\` - \`${member.user.id}\`
─────────────────────
